...
# taken from https://github.com/liviniuk/DORN_depth_estimation_Pytorch/tree/master
...
class DORN(nn.Module):
    def __init__(self, pretrained=True):
        ...
        self.scene_understanding_modulule = SceneUnderstandingModule()
