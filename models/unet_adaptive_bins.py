...
class PatchTransformerEncoder(nn.Module):
    ...
    def forward(self, x):
        #print('PatchTransformerEncoder.x.shape', x.shape)
...
class mViT(nn.Module):
    ...
    def forward(self, x):
        ...
        regression_head, queries = tgt[0, ...], tgt[1:self.n_query_channels + 1, ...] #problem is here
...
#     device = 'cuda:0'
#     model = UnetAdaptiveBins.build(100).to(device)
